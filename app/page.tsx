...
const PRE_REGISTERED_MEMBERS: { id: string; name: string; part: Part; grade: number }[] = [
  ...
  { id: "bs7", name: "安久啓悟", part: "Bass", grade: 1 }, { id: "bs8", name: "宇原央燿", part: "Bass", grade: 1 }, 
];
...
const QUESTIONS: Question[] = [
  ...
  { id: "q15", type: "tarekomi", title: "タレコミクイズ 15", text: "【北島光】\n脇腹が弱点。積極的に狙いに行こう", options: ["本当", "嘘"] },
  ...
  { id: "q25", type: "tarekomi", title: "タレコミクイズ 25", text: "【尾形朋紘】\n気絶してもいいようにアラームかけてテクノブレイクまでチャレンジしたことがある。", options: ["本当", "嘘"] },
  { id: "q26", type: "tarekomi", title: "タレコミクイズ 26", text: "【田中司真】\n後輩複数名に自分のうどんや特急券の代金を支払わせたことがある", options: ["本当", "嘘"] },
  ...
  { id: "q29", type: "tarekomi", title: "タレコミクイズ 29", text: "【藤田京子(OG)】\n実は何個か作問している。", options: ["本当", "嘘"] },
  { id: "q30", type: "tarekomi", title: "タレコミクイズ 30", text: "【岡田拓士】\n近所に出来た安い食べ放題の店に通いつめ、半年でその店を潰した。", options: ["本当", "嘘"] },
  ...
  { id: "q33", type: "tarekomi", title: "タレコミクイズ 33", text: "【西森晄志】\n居酒屋バイトで泣いた。", options: ["本当", "嘘"] },
  ...
  { id: "q50", type: "tarekomi", title: "タレコミクイズ 50", text: "【石川泰輝】\n女の子を鞭で叩いたり、蝋を垂らしたりするSMプレイが好き", options: ["本当", "嘘"] },
  ...
  { id: "i3", type: "intro", title: "イントロクイズ 3", text: "この曲のタイトルは何でしょう？", options: [], anagramWord: "わかくさもえて", shuffledChars: ["も", "く", "て", "わ", "さ", "え", "か"] },
  { id: "i4", type: "intro", title: "イントロクイズ 4", text: "この曲のタイトルは何でしょう？", options: [], anagramWord: "かれっじそんぐ", shuffledChars: ["ぐ", "ん", "れ", "か", "そ", "っ", "じ"] },
  { id: "i5", type: "intro", title: "イントロクイズ 5", text: "この曲のタイトルは何でしょう？", options: [], anagramWord: "うみげしき", shuffledChars: ["き", "み", "う", "し", "げ"] },
  { id: "i6", type: "intro", title: "イントロクイズ 6", text: "この曲のタイトルは何でしょう？", options: [], anagramWord: "いとうけいし", shuffledChars: ["け", "う", "い", "し", "と", "い"] },
  { id: "i7", type: "intro", title: "イントロクイズ 7", text: "この曲のタイトルは何でしょう？", options: [], anagramWord: "みなづきみのり", shuffledChars: ["の", "み", "り", "な", "き", "み", "づ"] },
