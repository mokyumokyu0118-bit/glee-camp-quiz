...
const PRE_REGISTERED_MEMBERS: { id: string; name: string; part: Part; grade: number }[] = [
  ...
  { id: "t9", name: "石井瑛士", part: "Top", grade: 1 }, 
  { id: "t10", name: "武内颯輝", part: "Top", grade: 1 }, { id: "t11", name: "谷川陸翔", part: "Top", grade: 1 },
  ...
  { id: "br9", name: "大嶽朋起", part: "Baritone", grade: 1 }, { id: "br5", name: "尾形朋紘", part: "Baritone", grade: 1 },
...
const QUESTIONS: Question[] = [
  ...
  { id: "q8", type: "tarekomi", title: "タレコミクイズ 8", text: "【田尻雄莉】\n寿司職人の1day仕事体験に参加したことがある。", options: ["本当", "嘘"] },
